					...
					<div class="news_channel" v-show="!text">
						<div class="clearfix mb-30">
							<div style="width:380px" class="fl mr-30">
								<iframe frameborder="0" src="https://v.qq.com/txp/iframe/player.html?vid=y0870jwjki0" allowFullScreen="true"
								 width="100%" height="214px"></iframe>
								<span class="video-title">海南广播电视台第一民生对亚太金融小镇的报道</span>
								<span class="fs-14 col-62 mt-8">来源：海南广播电视台</span>
							</div>
							<div style="width:380px" class="fl mr-30">
